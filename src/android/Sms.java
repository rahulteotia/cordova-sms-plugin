            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (partsCount == 0) {
                    if (anyError) {
                        ...
                        context.getContentResolver().delete(Uri.parse("content://sms/sent"), "address = ? and body = ?", new String[]{phoneNumber, message});
                        context.getContentResolver().delete(Uri.parse("content://sms/outbox"), "address = ? and body = ?", new String[]{phoneNumber, message});
                        callbackContext.sendPluginResult(new PluginResult(PluginResult.Status.OK));
                    }
